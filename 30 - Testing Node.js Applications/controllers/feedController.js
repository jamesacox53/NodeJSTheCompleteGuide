...
import controllerUtils from '../utils/controllerUtils/controllerUtils.js';
...
const putEditPost = (request, response, next) => {
    _putEditPost();
...
export default { getPost, getPosts, createPost, putEditPost, deletePost };